<div>
    <div class="grid grid-cols-[110px_auto] mt-5">
        ...
        <div>
            ...
            <a href="{{ route('profile') }}" class="border border-[#29af61] text-[#29af61] px-4 py-1.5 ">Edit Profil</a>
        </div>
    </div>
    <button id="kost_saya" class="flex mt-2 py-4 text-black border-b-2 w-full menu_btn hidden">
        <i class="fa-solid fa-house text-lg"></i> 
        <p class="ml-3 mt-1">Hotel Saya</p>
    </button>
    <button id="rwyt_book" class="flex mt-2 py-4 text-gray-500 border-b-2 w-full menu_btn">
        ...
        <p class="ml-3 mt-1">Riwayat Booking</p>
    </button>
    <button id="rwyt_kost" class="flex mt-2 py-4 text-gray-500 border-b-2 w-full menu_btn hidden">
        <i class="fa-solid fa-house-laptop text-lg"></i>
