<div class="max-w-5xl mx-auto px-2">
    <div class="border w-full rounded-lg mt-8">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="grid grid-cols-[25%_auto]  mt-5">
                ...
                <div>
                    <input class="w-full focus:ring-0 rounded-md border-gray-300" type="text" wire:model="name">
                </div>
            </div>
            ...
            <div class="grid grid-cols-[25%_auto]  mt-5">
                ...
                <div>
                    <input class="w-full focus:ring-0 rounded-md border-gray-300" type="number" wire:model="phone_number">
                </div>
            </div>
            ...
            <div class="grid grid-cols-[25%_auto]  mt-5 hidden">
                <div class="flex items-center">
                    Jenis Kelamin *
                </div>
                <div>
    ...
    <button class="w-full py-3 font-semibold bg-[#29af61] rounded-md mt-4 text-white"
        wire:click="update"
    >
        Update
    </button>
